...
class Like(models.Model):
    ...
    """
    user = models.ForeignKey(
        UserProfile, on_delete=models.CASCADE, related_name='liked_posts')
    post = models.ForeignKey(
...
class SocialCircles(models.Model):
    ...
    members = models.ManyToManyField(
        UserProfile, related_name='social_circles')
    created_by = models.ForeignKey(get_user_model(
    ), on_delete=models.CASCADE, default=None, related_name='created_social_circles')
...
class Favorites(models.Model):
    ...
    """
    user = models.ForeignKey(settings.AUTH_USER_MODEL,
                             on_delete=models.CASCADE, related_name="favorited")
...
class JournalEntry(models.Model):
    ...
    video = models.FileField(
        upload_to='journal_videos/', blank=True, null=True)
