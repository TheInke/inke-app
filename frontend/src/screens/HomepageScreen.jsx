...
const HomePage = () => {
    ...
    // Fetch user profile picture from the API
    useEffect(() => {
        const fetchUserProfilePic = async () => {
            try {
                ...
                const data = await response.json();
                setCurrentUserProfilePic(data.profile_pic_url || 'https://via.placeholder.com/150');
            } catch (error) {
    ...
    // Handle double tap to like a post
    ...
    // Handle opening the full-screen image view
    ...
    const handleAddComment = async () => {
        try {
            await fetch(`${API_URL}/posts/${selectedPost.id}/comments/create/`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${ACCESS_TOKEN}`,
                    'Content-Type': 'application/json',
    ...
    return (
        <View style={styles.container}>
            ...
            <Modal visible={showFullScreenImage} transparent={true} onRequestClose={closeFullScreenImage}>
                <PanGestureHandler onGestureEvent={onGestureEvent}>
                    <Animated.View style={styles.fullScreenImageContainer}>
                        <Pressable style={styles.fullScreenImageWrapper} onPress={closeFullScreenImage}>
            ...
            <View style={styles.footer}>
                <Pressable style={styles.footerButton} onPress={handleSearchPress}>
                    <FontAwesome name="search" size={24} color="white" />
                </Pressable>
                <Pressable style={styles.addButton} onPress={handleAddPost}>
                    <FontAwesome name="plus" size={24} color="black" />
                </Pressable>
                <Pressable style={styles.footerButton} onPress={handleProfilePress}>
                    <Image source={{ uri: currentUserProfilePic }} style={styles.profilePic} />
                </Pressable>
            </View>
        </View>
    );
