...
const HomeScreen = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.button} onPress={() => navigation.push('ExploreScreen')}>
      ...
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity style={styles.navItem}>
          <Ionicons name="search" size={24} color="black" onPress={() => navigation.push('ExploreScreen')} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.navItem}>
